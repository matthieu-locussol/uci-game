...
export const GITHUB_RELEASES_ENDPOINT =
  "https://api.github.com/repos/matthieu-locussol/unforeseen-conspiracy-inc/releases";

export const GITHUB_LATEST_RELEASE_ENDPOINT =
  "https://api.github.com/repos/matthieu-locussol/unforeseen-conspiracy-inc/releases/latest";
